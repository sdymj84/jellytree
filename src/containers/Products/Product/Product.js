...
const Product = () => {
  ...
  const handleAddToCart = () => {
    const product = _.find(products, { 'color': selectedColor, 'size': selectedSize })
  ...
  useEffect(() => {
    const available = _.filter(products, (product) => {
...
const colors = _.uniqBy(products, 'color')
const sizes = _.uniqBy(products, 'size')
